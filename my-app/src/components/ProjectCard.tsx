...
export const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  const renderFormattedCode = (rawCode?: string) => {
          ...
          <div className="pt-2">
            ...
            <ul className="grid grid-cols-1 gap-2.5 sm:grid-cols-2">
              {features.map((feature, idx) => {
                ...
                const featTitle = isObject ? (feature as FeatureItem).title : (feature as string);
                const featDesc = isObject ? (feature as FeatureItem).desc : undefined;
        ...
        {tags && tags.length > 0 && (
          <div className="pt-3 border-t border-slate-800/80">
            <div className="flex flex-wrap items-center gap-1.5">
              {tags.map((tag, idx) => {
                const tagName = typeof tag === "string" ? tag : (tag as TagItem).name;
                const tagVariant = typeof tag === "string" ? "secondary" : ((tag as TagItem).variant || "secondary");
                return (
